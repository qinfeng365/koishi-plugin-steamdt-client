...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("SteamDT API Service - Real-time Version")
    print("=" * 60)
    print(f"\nStarting API service...")
    print(f"Access: http://localhost:{port}")
    print(f"API Docs: http://localhost:{port}/docs")
    print("\nMain endpoints:")
    print(f"  - GET /api/scrape/table?scrolls=10 - Return table image")
    print(f"  - GET /api/scrape/json?scrolls=10 - Return JSON data")
    print(f"  - GET /api/scrape/csv?scrolls=10 - Return CSV data")
    print(f"  - GET /api/scrape/stats?scrolls=10 - Return statistics")
